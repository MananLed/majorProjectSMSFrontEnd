...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, LoginSignupComponent, NavbarComponent, MenuItemComponent, DashboardComponent, ServiceRequestsComponent, UserManagementComponent, FeedbackComponent, InvoiceComponent, NoticeComponent, ProfileComponent, LayoutComponent],
